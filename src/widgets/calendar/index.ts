import { CommonMessages, CustomAriaProperties } from '../common/interfaces';
import {
...
export class CalendarBase<P extends CalendarProperties = CalendarProperties> extends i18nBase<P, null> {
	...
	private _onDateKeyDown(event: KeyboardEvent, preventDefault: () => void) {
